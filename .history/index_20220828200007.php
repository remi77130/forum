    ...
    <div class="parent_form_signup">
        ...
        <div class="box">
            ...
            <form style="text-align: center;" method="POST" enctype="multipart/form-data">
                ...
                <!-- On cache la div "ville" parce qu'on a pas encore le département, elle sera affichée grâce à la requête Ajax-->
    ...
    $(document).ready(function () {
        ...
        $('#select_departement').on('change', function () {
            ...
            if (departement_code != "" && departement_code != undefined) {
                ...
                // On récupère le département sélectionnée et on fait une requête Ajax pour récupérer les villes qui correspondent

                // On utilise getJSON (qui est un équivalent d'Ajax mais correspond mieux pour cette requête)
