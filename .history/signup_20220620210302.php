...
<div>
  <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus recusandae debitis ullam nemo ad qui veniam error doloribus culpa non, minima suscipit officiis porro cum reprehenderit accusamus dicta facilis. Expedita?</p>
</div>
<div class="form_signup">

    <form class="form"  style="text-align: center;" method="POST" enctype="multipart/form-data">
