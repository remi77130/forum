...
<div class="index_container_1">
    ...
    <h2>Rejoignez chanderland et profitez gratuitement d'une messagerie pour faire des rencontres<h2> <br>

    <p>
    découvrez les profils autour de vous et envoyé des messages gratuitement <br>
     chanderland est un site de rencontre ultra simple aprendre en main
    </p>
</div>
