...
// recup commentaire *10
$commentaires = $bdd->query('Select * FROM commentaires ORDER BY id DESC LIMIT 10');
...
<?php while($c = $commentaires->fetch()) { ?>
      <li><?= $c['id'] ?> : <?= $c['pseudo'] ?><?php if($c['confirme'] == 0) { ?> - <a href="admin.php?type=membre&confirme=<?= $c['id'] ?>">Confirmer</a><?php } ?> - <a href="admin.php?type=membre&supprime=<?= $m['id'] ?>">Supprimer</a></li>
      <?php } ?>
</ul>
