      ...
      AND !empty($_POST['objet'])) 
      {
         ...
         if($dest_exist == 1) {
            ...
            if($isSaved == true)
            {
               ...
               $ins = $bdd->prepare('INSERT INTO messages(id_expediteur,id_destinataire,message,objet,img_msg,file_name,datafile) VALUES (?,?,?,?,?,?,?)');
               $ins->execute(array($_SESSION['id'],$id_destinataire,$message,$objet,$img_msg,$img_msg));      
            }
