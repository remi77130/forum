...
<br>
<div>
<a href="actions/action.php?t=1&id=<?= $userinfo ?>">J'aime</a> (15) <br> <br>  <!-- t pour le type de laction --> <br>
<a href="actions/action.php?t=2&id=<?= $userinfo ?>">Je n'aime pas </a>(5) <br> <br>
</div>
