...
<div class="nav-links">
    ...
    <li>
    <a  id="myBtn" href="#">Filtre</a> <span style="border: 3px solid green; padding-top: 15px;"> <img src="icones/chanderland_search.svg" alt="chanderland" style="width: 20px;"></span>
    </li>
