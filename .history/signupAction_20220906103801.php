...
if (!empty($_POST['pseudo'])
    ...
    if ($password != $password2) {
        $erreur += "Votre password ne correspond pas ! <br>";
        $registrationPass = false;
    }
    ...
    if ($userexist == 1) {
        $erreur += "Pseudo d&eacute;j&agrave; utilis&eacute; <br>";
    }
    ...
    if ($mailexist != 0){
        $erreur += "Votre mail est d&eacute;j&agrave; utilis&eacute; par un autre compte <br>";
        $registrationPass = false;
    }
