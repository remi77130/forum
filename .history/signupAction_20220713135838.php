...
$message->body ="Bonjour <trong>$pseudo</stron> et bienvenue sur le site.
Vous pouvez vous connectez ici ";

$message->ALtBody ="Bonjour $pseudo et bienvenue sur le site. 
Vous pouvez vous connectez ici  "; // POUR USER NE LIE PAS HTML
