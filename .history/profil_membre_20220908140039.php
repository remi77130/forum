...
$requser = "SELECT * FROM membres, villes_france ORDER BY id DESC";
...
$requser_2 = "SELECT * FROM membres, villes_france ORDER BY id DESC";
$requete_2 = $bdd->query($requser_2);
// RECUPERE LES DONEES 
$articles_2 = $requete_2->fetchAll(); ?>
...
<div class="container_profil_info_pseudo">    
    <span><?php echo $articles['departement_nom'] ?> </span>
</div>
