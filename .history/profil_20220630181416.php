...
if(isset($_POST['msg_user'])) {
   if(isset($_POST['msg'],$_POST['objet']) 
   AND !empty($_POST['msg']) AND !empty($_POST['objet']) 
   ...
   <body>
      <div > <!-- Profil visible-->
        ...
        <?php echo $userinfo['mail']; ?> <br><br>
         ...
         <textarea placeholder="Votre message" name="msg"></textarea><br>
         <br /><br />
         <input type="submit" value="Envoyer" name="msg_user" />
         <br /><br />
