...
<div class="option_profil_user">
   ...
   <a href="" onClick="messagerie()" >Ecrire</a>
...
?>
   ...
   <script type="text/javascript">   
      ...
      function messagerie(){
         if($("parent_message_profil_user").hasClass("active")){
            $("parent_message_profil_user").removeClass("active");
         }else{
            $("parent_message_profil_user").addClass("active");
         }
      }
   </script>
</html>
