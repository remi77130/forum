...
<h2>Comment faire des rencontres rapides ? <h2>
    ...
    <div>
    <h2>Site de rencontre gratuit</h2>
 
    <p>
    Profitez d'une messagerie pour faire <span style="font-weight: bold;">des rencontres gratuites pré de chez vous.</span> 
    </p>
...
<h2>Comment faire des rencontres rapides ? <h2>
    ...
    <p>
    Rejoignez chanderland et profitez <span style="font-weight: bold;">gratuitement d'une messagerie</span> pour faire des rencontres rapides.<br>
...
<div class="container_footer">
    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eaque quasi eius nam magnam eligendi cupiditate fugiat a architecto, laboriosam nihil exercitationem dolorem consequuntur culpa ut ipsa quisquam inventore perspiciatis! Autem.</p>
</div>
