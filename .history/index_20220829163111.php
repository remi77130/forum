    ...
    <div class="parent_form_signup">
        ...
        <div class="box">
            ...
            <form style="text-align: center;" method="POST" enctype="multipart/form-data">
                ...
                <!-- EN COMMENTAIRE POUR LE FONCTIONNEMENT EN LOCAL POUR L'INSTANT. NE PAS OUBLIER 
                SIGNUPACTION.PHP POUR RAJOUTER 'DEPARTEMENT' ET 'VILLE_ID' DANS LA REQUETE D'INSERTION MEMBRES -->
