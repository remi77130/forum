        ...
        <div class="profil_membre">
            ...
            <div class="info_profil">
                ...
                <div class="info_pseudo_age">
                    <span class="pseudo_profil"><?php echo $userinfo['pseudo']; ?></span> <br> <br>
                    <span class="age_profil">Age <?php echo $userinfo['age'] ?></span> <br>
                    <span class="taille"><?php echo $userinfo['taille'] ?> Cm </span>
                    <span>pour <?php echo $userinfo['poids'] ?> kilos</span> <br>
                    <span>Ici pour <?php echo $userinfo['choix'] ?></span>

                    <?php
                    
                    if (empty($_POST['taille']) && empty($_POST['taille']) && empty($_POST['taille']{
                        echo "rien";
                    }
                    ?>
 <!--// Si un message est envoyé sur un profil
    if (!empty($_POST['envoi_message']) && !empty($_FILES)) {
        $error = send_message($_POST['destinataire_id'], $_POST, $_FILES);
                ...
                <div>
                    <p>Signe <?php echo $userinfo['astrologie']; ?></p>
                </div>
