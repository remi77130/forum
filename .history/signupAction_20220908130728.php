 ...
 */
 ...
 if($registrationPass == true){
    ...
    $insertmbr = $requser->fetch();
    $_SESSION['id'] = $insertmbr['id'];
    $_SESSION['pseudo'] = $insertmbr['pseudo'];
    $_SESSION['mail'] = $insertmbr['mail'];
    header("Location: profil_membre.php"); // USERS REDIRIGE SUR LA PAGE INDEX VIA CONNEXION.PHP
    
    //header("Location: profil_membre.php");
    // RENVOIE SUR UNE ERREUR C:\xampp\htdocs\Forum\profil_membre.php on line 40">Mon Profil
    // PB BDD JE PENSE 
