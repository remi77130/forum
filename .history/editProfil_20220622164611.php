...
if (empty($requser['avatar']))
{
?>
<img src="membres\avatars/<?php echo $requser['avatar']; ?>" alt="photo_profil" width="150">
<?php
...
?> 
             ...
             <form method="POST" action="" enctype="multipart/form-data">
               ...
               cols="30" rows="5" > <?php echo $user['description_profil']; ?>  </textarea> <br> <br>
