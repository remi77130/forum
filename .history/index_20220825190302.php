...
<select class="form-control" id="inputdepart" name="inputdepart" require>

<option value="">Selectionnez un département</option>
<?php 
while($row=$pdo_stmt2->fetch(PDO::FETCH_ASSOC)):
?>

<option value="<?php echo $row["departement_code"]?>"> 
<?php echo $row["departement_nom"]?></option>
...
<select id="inuputville" name="inuputville" required>
  <option value="">Selectionne d'abord un département</option>
