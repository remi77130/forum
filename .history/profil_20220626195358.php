...
<br>
        ...
        <span><?php echo $userinfo['pseudo']; ?> <nl2br>
         
        </span><?php echo $userinfo['age']; ?>  <br> <br>

       <span></span> <?php echo $userinfo['astrologie']; ?> <br> <br></span>
  
        <span> <?php echo $userinfo['description_profil']; ?> <br> <br></span>
