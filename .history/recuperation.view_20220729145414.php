...
<?php } elseif ($section == "changemdp") {?>
   Nouveau mot de passe pout <br> <b><?= $_SESSION['recup_mail']?><b> <br><br>

   <form method="post">
   <input type="password" placeholder="Nouveau mot de passe" name="verif_code"/><br/>
   <input type="password" placeholder="Confirmation du mot de passe" name="verif_code"/><br/>
   <input type="submit" value="Valider" name="verif_submit"/>
</form>
<?php } else {?>
