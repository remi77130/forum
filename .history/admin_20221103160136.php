...
<?php while($m = $membres->fetch()) { ?>
      <li><?= $m['id'] ?> : <?= $m['pseudo'] ?><?php if($m['confirme'] == 0) { ?> - 
        <a href="admin.php?<?= $m['id'] ?>">Confirmer</a><?php } ?> - <a href="admin.php?<?= $m['id'] ?>">Supprimer</a></li>
      <?php } ?>
</ul> <br><br><br>
...
<ul>
      ...
      <li><?= $c['id'] ?> : <?= $c['idMembre'] ?> : <?= $c['contenu'] ?>
      <?php if($c['approuve'] == 0) { ?> - <a href="admin.php?<?= $c['id'] ?>">
        Approuver</a><?php } ?> - <a href="admin.php?<?= $c['id'] ?>">Supprimer</a></li>
      <?php } ?>
   </ul>
