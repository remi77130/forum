...
$articles = "SELECT * FROM departement";
$pdostmt = $bdd->prepare($articles);
$pdostmt->execute();


$requser = $bdd->prepare("SELECT * FROM departement");  // REQUETE SI MAIL EXISTE DEJA
...
<option value="<?php echo $articles["departement_code"]?>"><?php echo $articles["departement_nom"]?></option>
