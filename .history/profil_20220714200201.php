   ...
   <body>
      <div > <!-- Profil visible-->
        ...
        <?php echo $userinfo['mail']; ?> <br><br>
         ...
         <img src="membres\avatars/<?php echo $id['avatar']; ?>" alt="photo_profil" width="150"><br>
       

<br>
<div>
<a href="actions/action.php?t=1&id=<?= $id ?>">J'aime</a> (15) <br> <br>  <!-- t pour le type de laction --> <br>
