...
<html>
   ...
   <a href="send_message.php" target="_blank"> Ecrire</a>
...
<!------------------- FICHE PROFIL USERS CONNECT NON VISIBLE PUBLIC ------->
...
<a href="ajouter-photo.php">Ajouter une photo à mon album</a> <br><br>

<form method="post" enctype="multipart/form-data">

<input type="file" name="image"><br><br>

<input type="submit" name="envoyer" value="charger"><br>
</form>
