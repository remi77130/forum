...
<button style="background-color:#55acee ; width:100px; height:80px;" class="button share_twitter" data-url="http:gogle.com">
...
<button style="background-color:#55acee ; width:100px; height:80px;" class="button share_twitter" data-url="http://....">
...
<button style="background-color:#55acee ; width:100px; height:80px;" class="button share_twitter" data-url="http://....">
<svg><use xlink:href="img/sprite.svg#gplus"></use></svg>
...
<button style="background-color:#55acee ; width:100px; height:80px;" class="button share_twitter" data-url="http://....">
<svg><use xlink:href="img/sprite.svg#linkedin"></use></svg>
