...
// REQUETTE QUI PERMET DE SELECTIONNEZ LE NON DES DPT DANS LA BDD requetet a faire dans la signupaction 

$reqdpt="SELECT * FROM departement";
$pdostmt = $bdd->prepare($reqdpt);
$pdostmt->execute();
...
<option value="<?php echo $row["departement_code"]?>"><?php echo $row["departement_code"]?></option>

<?php // FERMETURE BOUCLE DPT

endwhile;?>
</select>

<label for="inputville">Ville</label>
<input type="text" id="inputville" name="inputville"> <br>
