...
if(!empty($_POST['search'])) {
    ...
    if(!empty($_POST('pseudo'))){
        $pseudo = intval(htmlspecialchars($_POST['pseudo']));
...
<div class="modal-content">
    ...
    <p>Je recherche des </p>
        <label>Homme
        <input type="checkbox" name="homme" value="1" id="checkMen" /><br>
        </label> <br>

        <label>Femme
        <input type="checkbox" name="femme" value="1" id="checkWomen" /> <br>
        </label>
    ...
    <div>
        ...
        <input class="pseudo_search" name="pseudo" type="text">
