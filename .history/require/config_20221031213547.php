...
const DB_USER = "oemr6702_forum"; // L'utilisateur de la DB
const DB_PASS = "Remi123&"; // Le mot de passe de la DB
const DB_BASE = "oemr6702_remi"; // La nom de la base de données
?>