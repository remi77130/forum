...
<div class="nav-links">
    ...
    <li>
    <a  id="myBtn" href="#">Filtre</a> <span style="border: 3px solid green;"> <img src="icones/chanderland_search.svg" alt="chanderland" style="width: 20px; padding-top:15px;"></span>
    </li>
