...
<br>
<div>
<a href="actions/action.php?t=1&id=<?= $userinfo['avatar']; ?>">J'aime</a> (15) <br> <br>  <!-- t pour le type de laction --> <br>
<a href="actions/action.php?t=2&id=<?= $userinfo['avatar']; ?>">Je n'aime pas </a>(5) <br> <br>
</div>
         ...
         <!-- photo album uploads -->
         <img src="membres\Uploads/<?php echo $userinfo['album']; ?>" alt="photo_album" width="150"><br>
