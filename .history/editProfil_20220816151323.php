...
if(isset($_SESSION['id'])) //autorisation affichage page si compte existe
{
   ...
   //Modification  mail
    ...
    if($executeRequest==true){
      $updateProfil = $bdd->prepare('UPDATE membres (pseudo, description_profil, astrologie, age, mail, mdp, avatar) values (:pseudo, :description_profil, :astrologie, :age, :mail, :mdp, :avatar) WHERE id = :id');
