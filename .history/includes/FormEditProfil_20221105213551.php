...
<div>
             ...
             <form method="POST" action="" enctype="multipart/form-data">
               ...
               <option value="Relation sérieuse">Ici pour Relation sérieuse</option>
               <option value="On verra bien">Ici pour On verra bien</option>
               <option value="Plan cul">Ici pour Plan cul</option>
               <option value="t'es de la police ?">Ici pour T'es de la police ?</option>
               </select>
