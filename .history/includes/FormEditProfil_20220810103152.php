...
<div>
             ...
             <form method="POST" action="" enctype="multipart/form-data">
               ...
               <label>Taille</label> <br>
                  ...
                  <option value="<?php $grand;?>">Ultra grand(e) (j'arrive à changer les ampoule sans monter sur la chaise)</option>

               </select> <br>
               <?php $grand = "Ultra grand(e) (j'arrive à changer les ampoule sans monter sur la chaise)";?>
