...
<div>
             ...
             <form method="POST" action="" enctype="multipart/form-data">
               ...
               <label>Taille</label> <br>
                  ...
                  <option value="nul"></option>
                  <option value="petit(e)">Petit(e) est mignion(e) (enfin c'est ce qu'on dit) </option>
                  <option value="moyen">Je suis dans la moyenne (j'ai pied dans la piscine)</option>
                  <option value="grand">Ultra grand(e) (j'arrive à changer <br /> <br> les ampoule sans monter sur la chaise)</option>
