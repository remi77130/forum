       ...
       <div class="edit_profil_container">
          ...
          <div>
             ...
             <form method="POST" enctype="multipart/form-data">
               ...
               <select name="choix">
                  <option value="nul"></option>
                  <option value="Trouver l'amour">Trouver l'amour</option>
                  ...
                  <option value="J'ai besoin de trouver un partenaire <br> de confiance pour enterré quelque chose dans mon jardins">J'ai besoin de trouver un partenaire de confiance pour enterré quelque chose dans mon jardins</option>
