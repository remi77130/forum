...
<?php
   ...
   echo count($tab);
   if(count($tab)<$param['limit_image_album']){ // Si le compteur utilisateur est inférieur à la limitation d'ajout d'image aux albums
?>
 ...
 ?>
   ...
   <?php
      ...
      Vous avez atteint la limite d'ajout d'images.
   <?php
         }
      ?>
