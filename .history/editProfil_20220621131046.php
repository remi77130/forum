...
if(isset($_SESSION['id'])) //autorisation affichage page si compte existe
{
    ...
    //PHOTO UPLOAD VOIR PAR LA SUITE POUR ENREGISTRER LE NAME DE LA PHOTO DANS LA BDD...
       ...
       <div>
          ...
          <div>
             <form method="POST" action="" enctype="multipart/form-data">
               ...
               <textarea style="border-radius: 5px; border: none; box-shadow: 5px 3px 10px black;" name="description_profil" cols="30" rows="5" placeholder="Bonjour, je suis ici car..."></textarea> <br> <br>
