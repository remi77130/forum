...
<span class="pseudo_profil"><?php echo $userinfo['pseudo']; ?></span>
            ...
            <div class="info_profil">
                ...
                <div class="info_pseudo_age">
                    <span>Age <?php echo $userinfo['age'] ?></span> <br> <br>
                    <span class="taille">Taille :<?php echo $userinfo['taille'] ?> Cm</span> <br> <br>
                    <span><?php echo $userinfo['poids'] ?> Kilos</span> <br> <br>
                    <span><?php echo $userinfo['choix'] ?></span> <br> <br>
                    <span><?php echo $userinfo['astrologie']; ?></span><br> <br>
