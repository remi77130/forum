...
<section class="section_signup" style="background-image: url(http://localhost/Forum/img/cross.jpg">


<div class="title_section_signup">
  <h2>Faite de nouvel connaissance avec <br>
   des Chrétient prés de chez vous </h2>
