        ...
        if($pseudolength <= 255)
        {
            ...
            if($password == $password2)  // verif password
            {
                ...
                if($password == $password2)
                {
                    ...
                    $insertmbr = $bdd->prepare("INSERT INTO membres (pseudo, mail, mdp, age, 
                    sexe, religion, confirmKey) VALUES(?,?,?,?,?,?,?)");
                    $insertmbr->execute(array($pseudo, $mail, $password, $age, $sexe, $religion, $key));
