...
<?php while($c = $membres->fetch()) { ?>
      <li><?= $c['id'] ?> : <?= $c['pseudo'] ?><?php if($c['confirme'] == 0) { ?> - <a href="admin.php?type=membre&confirme=<?= $c['id'] ?>">Confirmer</a><?php } ?> - <a href="admin.php?type=membre&supprime=<?= $c['id'] ?>">Supprimer</a></li>
      <?php } ?>
</ul>
