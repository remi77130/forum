...
<head>
  ...
  <META NAME="DESCRIPTION" CONTENT="Connectez-vous sur chanderland pour faire des rencontres gratuites." />
  ...
  <title>Connexion sur chanderland</title>
</head>
  ...
  <div class="grid">
    ...
    <form class="form login" method="POST" action="">
      ...
      <div class="form__field">
        ...
        <input autocomplete="username" id="login__username" type="text" name="pseudoconnect" class="form__input" placeholder="Pseudo" required>
      </div>
      ...
      <div class="form__field">
        ...
        <input id="login__password" type="password" name="mdpconnect" class="form__input" placeholder="Password" required>
      </div>
    ...
    <p class="text--center">Je n'ai pas de compte <a href="index.php">Inscription</a> <svg class="icon">
