...
-->
               ...
               <select name="astrologie">
                  ...
                  <option value="Je suis bélier">Bélier</option>
                  <option value="Je suis taureau">Taureau</option>
                  <option value="Je suis gémeaux">Gémeaux </option>
                  <option value="Je suis cancer">Cancer </option>
                  <option value="Je suis lion">Lion</option>
                  <option value="Je suis vierge">Vierge </option>
                  <option value="Je suis balance">Balance </option>
                  <option value="Je suis scorpion">Scorpion </option>
                  <option value="Je suis sagittaire">Sagittaire </option>
                  <option value="Je suis capricorne">Capricorne </option>
                  <option value="Je suis verseau">Verseau</option>
            ...
            <label>Taille</label> <br>
               ...
               <option value="Taille : 135 Cm">135 cm</option>
            ...
            <option value="Je suis couple">En couple</option>
            <option value="Je suis celibataire">Celibataire</option>
